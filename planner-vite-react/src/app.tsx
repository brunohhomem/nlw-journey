        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-lg py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <div className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
                <span className="text-zinc-300">jayceblack@yahoo.com</span>
                <button type="button">
                  <X className="size-4 text-zinc-400" />
                </button>
              </div>
              ...
              <div className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
                <span className="text-zinc-300">andrea.wh@yahoo.com</span>
                <button type="button">
                  <X className="size-4 text-zinc-400" />
                </button>
              </div>
              ...
              <div className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
                <span className="text-zinc-300">audrey@yahoo.com</span>
                <button type="button">
                  <X className="size-4 text-zinc-400" />
                </button>
              </div>
